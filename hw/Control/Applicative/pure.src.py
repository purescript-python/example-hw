...
res = block( "No document"
           , assign_star( "ps_Control_Apply"
                        , call(var('import_module'), "hw.Control.Apply.pure") )
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( ite( uop( UOp.NOT
                                                                               ...
                                                                               , throw( new( var( "ps_Error" )
                                                                                           , binop( "Failed pattern match at hw.Control.Applicative.pure (line 62, column 1 - line 62, column 65): "
                                                                                                  , BinOp.ADD
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( ite( var( "ps_v" )
                                                                               ...
                                                                               , ite( uop( UOp.NOT
                                                                                    ...
                                                                                    , None )
                                                                               , throw( new( var( "ps_Error" )
                                                                                           , binop( "Failed pattern match at hw.Control.Applicative.pure (line 57, column 1 - line 57, column 63): "
                                                                                                  , BinOp.ADD
                                                                                                  , mktuple( get_attr( get_item( var( "ps_v" )
                                                                                                                               , ".t" )
                                                                                                                     , "__name__" )
           ...
           , assign_star( "ps_applicativeArray"
                        , new( var("ps_Applicative")
                             ...
                             , define( None
                                     , ["ps_x"]
                                     , block( ret( metadata( 39
                                                           , 12
                                                           , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Control\\Applicative.purs"
                                                           , mktuple( var( "ps_x" ) ) ) ) ) ) ) )
           , assign( "exports"
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Control\\Applicative.purs", name="hw.Control.Applicative.pure")
