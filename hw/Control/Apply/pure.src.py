...
res = block( "No document"
           , assign_star( "$foreign"
                        , call(var('import_module'), "hw.ffi.Control.Apply") )
           , assign_star( "ps_Control_Category"
                        , call( var('import_module')
                              , "hw.Control.Category.pure" ) )
           , assign_star( "ps_Data_Function"
                        , call(var('import_module'), "hw.Data.Function.pure") )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Control\\Apply.purs", name="hw.Control.Apply.pure")
