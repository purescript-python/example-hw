...
res = block( "No document"
           , assign_star( "$foreign"
                        , call( var('import_module')
                              , "hw.ffi.Data.EuclideanRing" ) )
           , assign_star( "ps_Data_CommutativeRing"
                        , call( var('import_module')
                              , "hw.Data.CommutativeRing.pure" ) )
           ...
           , assign_star( "ps_euclideanRingNumber"
                        , new( var("ps_EuclideanRing")
                             ...
                             , define( None
                                     , ["ps_v"]
                                     , block( ret( metadata( 76
                                                           , 14
                                                           , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\EuclideanRing.purs"
                                                           , 1 ) ) ) )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\EuclideanRing.purs", name="hw.Data.EuclideanRing.pure")
