...
res = block( "No document"
           , assign_star( "$foreign"
                        , call(var('import_module'), "hw.ffi.Data.Functor") )
           , assign_star( "ps_Control_Semigroupoid"
                        , call( var('import_module')
                              , "hw.Control.Semigroupoid.pure" ) )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Functor.purs", name="hw.Data.Functor.pure")
