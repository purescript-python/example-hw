...
res = block( "No document"
           , assign_star( "$foreign"
                        , call(var('import_module'), "hw.ffi.Data.Ord") )
           , assign_star( "ps_Data_Eq"
                        , call(var('import_module'), "hw.Data.Eq.pure") )
           , assign_star( "ps_Data_Ordering"
                        , call(var('import_module'), "hw.Data.Ordering.pure") )
           , assign_star( "ps_Data_Ring"
                        , call(var('import_module'), "hw.Data.Ring.pure") )
           , assign_star( "ps_Data_Semiring"
                        , call(var('import_module'), "hw.Data.Semiring.pure") )
           , assign_star( "ps_Data_Symbol"
                        , call(var('import_module'), "hw.Data.Symbol.pure") )
           , assign_star( "ps_Record_Unsafe"
                        , call(var('import_module'), "hw.Record.Unsafe.pure") )
           , assign_star( "ps_Type_Data_RowList"
                        , call( var('import_module')
                              , "hw.Type.Data.RowList.pure" ) )
                                     ...
                                     , block( ret( define( None
                                                         ...
                                                         , block( ite( ite( isa( var( "ps_v" )
                                                                ...
                                                                , throw( new( var( "ps_Error" )
                                                                            , binop( "Failed pattern match at hw.Data.Ord.pure (line 112, column 1 - line 119, column 21): "
                                                                                   , BinOp.ADD
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( assign_star( "ps_v"
                                                                               ...
                                                                               , ite( isa( var( "ps_v" )
                                                                                         , get_item( var( "ps_Data_Ordering" )
                                                                                                   , "GT" ) )
                                                                                    , block( ret( metadata( 130
                                                                                                          , 9
                                                                                                          , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Ord.purs"
                                                                                                          , True ) ) )
                                                                                    , None )
                                                                               , ret( metadata( 131
                                                                                              , 8
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( assign_star( "ps_v"
                                                                               ...
                                                                               , ite( isa( var( "ps_v" )
                                                                                    ...
                                                                                    , None )
                                                                               , throw( new( var( "ps_Error" )
                                                                                           , binop( "Failed pattern match at hw.Data.Ord.pure (line 167, column 3 - line 170, column 12): "
                                                                                                  , BinOp.ADD
                                                                                                  , mktuple( get_attr( get_item( var( "ps_v" )
                                                                                                                               , ".t" )
                                                                                                                     , "__name__" ) ) ) ) ) ) ) ) ) ) ) ) ) )
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( assign_star( "ps_v"
                                                                               ...
                                                                               , ite( isa( var( "ps_v" )
                                                                                    ...
                                                                                    , None )
                                                                               , throw( new( var( "ps_Error" )
                                                                                           , binop( "Failed pattern match at hw.Data.Ord.pure (line 158, column 3 - line 161, column 12): "
                                                                                                  , BinOp.ADD
                                                                                                  , mktuple( get_attr( get_item( var( "ps_v" )
                                                                                                                               , ".t" )
                                                                                                                     , "__name__" ) ) ) ) ) ) ) ) ) ) ) ) ) )
                                                                                           ...
                                                                                           , block( ret( define( None
                                                                                                               ...
                                                                                                               , block( assign_star( "ps_v"
                                                                                                                      ...
                                                                                                                      , ite( isa( var( "ps_v" )
                                                                                                                           ...
                                                                                                                           , None )
                                                                                                                      , throw( new( var( "ps_Error" )
                                                                                                                                  , binop( "Failed pattern match at hw.Data.Ord.pure (line 65, column 7 - line 68, column 17): "
                                                                                                                                         , BinOp.ADD
                                                                                                                                         , mktuple( get_attr( get_item( var( "ps_v" )
                                                                                                                                                                      , ".t" )
                                                                                                                                                            , "__name__" ) ) ) ) ) ) ) ) ) ) )
           ...
           , assign( "exports"
                   , record( ("Ord", var("ps_Ord"))
                           ...
                           , ("ordRecord", var("ps_ordRecord")) ) ) )
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Ord.purs", name="hw.Data.Ord.pure")
