                             ...
                             , define( None
                                     ...
                                     , block( ite( isa( var("ps_v")
                                            ...
                                            , throw( new( var("ps_Error")
                                                        , binop( "Failed pattern match at hw.Data.Ordering.pure (line 26, column 1 - line 29, column 17): "
                                                               , BinOp.ADD
                                     ...
                                     , block( ret( define( None
                                                         ...
                                                         , block( ite( isa( var( "ps_v" )
                                                                ...
                                                                , ite( isa( var( "ps_v" )
                                                                     ...
                                                                     , None )
                                                                , throw( new( var( "ps_Error" )
                                                                            , binop( "Failed pattern match at hw.Data.Ordering.pure (line 21, column 1 - line 24, column 18): "
                                                                                   , BinOp.ADD
                                                                                   , mktuple( get_attr( get_item( var( "ps_v" )
                                                                                                                , ".t" )
                                                                                                      , "__name__" )
                        ...
                        , define( None
                                ...
                                , block( ite( isa(var("ps_v"), var("ps_GT"))
                                       ...
                                       , ite( isa(var("ps_v"), var("ps_LT"))
                                            ...
                                            , None )
                                       , throw( new( var("ps_Error")
                                                   , binop( "Failed pattern match at hw.Data.Ordering.pure (line 33, column 1 - line 33, column 31): "
                                                          , BinOp.ADD
                                                          , mktuple( get_attr( get_item( var( "ps_v" )
                                                                                       , ".t" )
                                                                             , "__name__" ) ) ) ) ) ) ) )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Ordering.purs", name="hw.Data.Ordering.pure")
