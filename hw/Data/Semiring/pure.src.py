...
res = block( "No document"
           , assign_star( "$foreign"
                        , call(var('import_module'), "hw.ffi.Data.Semiring") )
                        ...
                        , new( var("ps_SemiringRecord")
                             , define( None
                                     ...
                                     , block( ret( define( None
                                                         ...
                                                         , block( ret( define( None
                                                                             , [ "ps_v2" ]
                                                                             , block( ret( metadata( 88
                                                                                                   , 22
                                                                                                   , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Semiring.purs"
                                                                                                   , record(  ) ) ) ) ) ) ) ) ) ) )
                             , define( None
                                     , ["ps_v"]
                                     , block( ret( define( None
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Semiring.purs", name="hw.Data.Semiring.pure")
