...
res = block( "No document"
           , assign_star( "$foreign"
                        , call(var('import_module'), "hw.ffi.Data.Show") )
                        ...
                        , new( var("ps_ShowRecordFields")
                             , define( None
                                     ...
                                     , block( ret( define( None
                                                         , ["ps_v1"]
                                                         , block( ret( metadata( 50
                                                                               , 26
                                                                               , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Show.purs"
                                                                               , mktuple(  ) ) ) ) ) ) ) ) ) )
           , assign_star( "ps_showRecordFields"
                        , define( None
                                , ["ps_dict"]
                             ...
                             , define( None
                                     ...
                                     , block( ite( var("ps_v")
                                            ...
                                            , throw( new( var("ps_Error")
                                                        , binop( "Failed pattern match at hw.Data.Show.pure (line 20, column 1 - line 22, column 23): "
                                                               , BinOp.ADD
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\prelude\\v4.1.1\\src\\Data\\Show.purs", name="hw.Data.Show.pure")
