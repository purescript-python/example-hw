...
res = block( "No document"
           , assign_star( "$foreign"
                        , call(var('import_module'), "hw.ffi.Effect.Console") )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\v0.1\\hw\\.spago\\console\\v4.4.0\\src\\Effect\\Console.purs", name="hw.Effect.Console.pure")
